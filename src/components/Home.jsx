  ...
  return (
    <div name='home' className='w-full h-screen bg-[#0a192f] md:flex justify-center items-center'>
      ...
      <div className='max-w-[1000px] mx-auto px-4 flex flex-col justify-center h-full'>
        ...
        >
          <Link className='group text-white border-2 px-6 py-3 my-2 flex items-center hover:bg-pink-600 hover:border-pink-600 sm:w-[30%] ' onClick={handleClick} to="work" smooth={true} duration={500}>View Projects
